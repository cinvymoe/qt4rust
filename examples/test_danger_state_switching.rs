...
async fn main() {
    ...
    let sensor_data_1 = SensorData::from_tuple(23.0, 10.0, 60.0, false, false); // 高载荷，触发报警
    ...
    let sensor_data_2 = SensorData::from_tuple(24.0, 10.0, 60.0, false, false); // 仍然高载荷
    ...
    let sensor_data_3 = SensorData::from_tuple(10.0, 10.0, 60.0, false, false); // 低载荷，解除报警
    ...
    let sensor_data_4 = SensorData::from_tuple(25.0, 10.0, 60.0, false, false); // 再次高载荷
    ...
    let sensor_data_5 = SensorData::from_tuple(8.0, 10.0, 60.0, false, false); // 低载荷
