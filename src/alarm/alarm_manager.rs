...
use super::alarm_type::{AlarmType, AlarmSource};
use super::alarm_checker::{AlarmChecker, AlarmCheckResult, MomentAlarmChecker, AngleAlarmChecker, LoadOverloadChecker};
...
impl AlarmManager {
    ...
    /// 应用防抖机制
    fn apply_debounce(&self, source: AlarmSource, result: AlarmCheckResult) -> Option<AlarmCheckResult> {
