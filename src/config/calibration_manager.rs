...
mod tests {
    ...
    fn test_round_trip_preserves_data() {
        ...
        assert_eq!(loaded_config.weight.zero_value, original_config.weight.zero_value);
        assert_eq!(loaded_config.angle.zero_ad, original_config.angle.zero_ad);
        assert_eq!(loaded_config.radius.scale_value, original_config.radius.scale_value);
    }
}